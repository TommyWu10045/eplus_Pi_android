...
public class MyImageView extends ImageView {
    ...
    public void setPhoto2BackGround(String photoPath, String fileName, int backGroundPic) {

        try {
            int showWidth = m_DisplayMetrics.widthPixels;
            int showHeight = m_DisplayMetrics.heightPixels;


            Bitmap b2 = BitmapFactory.decodeResource(getResources(), backGroundPic);
            Bitmap b1 = MyBitmap.getBitmap(MyBitmap.TYPE_DECODE_FILE, photoPath, showWidth, showHeight, getContext(), true);
            m_Bitmap = MyBitmap.combineBitmap(b2, b1);
            b2.recycle();
            b1.recycle();

            //   m_Bitmap = MyBitmap.getBitmap(MyBitmap.TYPE_DECODE_FILE, photoPath, showWidth, showHeight, getContext(), true);
            m_FileName = fileName;
            ...
            MyLog.e("setPhoto2BackGround ERROR " + e.toString());
        }
    }
